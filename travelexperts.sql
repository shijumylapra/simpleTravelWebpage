...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2019 at 11:59 PM
...
CREATE TABLE `bookings1` (
  ...
  `TravelerCount` int(11) NOT NULL,
  `CustomerId` int(11) NOT NULL,
  `TripTypeId` varchar(10) NOT NULL,
...
INSERT INTO `contact` (`Customer ID`, `Email`, `Text`) VALUES
(1, '', ''),
(2, '', ''),
(3, '', ''),
(4, '', ''),
(5, '', ''),
(6, '', ''),
(7, '', 'Hi,\r\nMy first name is Kevin and my last name is Loo.'),
(8, 'kevinloo300@gmail.com', 'Hi,\r\nMy first name is Kevin and my last name is Loo.'),
(9, 'kevinloo300@gmail.com', 'Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and my last name is Loo.Hi,\r\nMy first name is Kevin and '),
(10, 'kevinloo300@gmail.com', 'Hello,\r\nsgadg jj jjd fjfj jjf gjjfg jjfg jjfg '),
(11, 'kevinloo300@gmail.com', ' Your Message Here  Your Message Here   Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here '),
(12, 'kevinloo300@gmail.com', ' Your Message Here  Your Message Here   Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here   Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here '),
(13, 'brandon@gmail.com', ' Your Message Here  Your Message Here   Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here  Your Message Here '),
(14, 'kevinloo300@gmail.com', 'Hello,\r\nsgadg jj jjd fjfj jjf gjjfg jjfg jjfg '),
(15, 'kevinloo300@hotmail.com', 'Hello, my name is Kevin and I like to play Overwatch.'),
(0, '', ''),
(0, '', ''),
(0, '', ''),
(0, '', ''),
...
--
-- Dumping data for table `cusbooking`
--

INSERT INTO `cusbooking` (`BookingId`, `BookingDate`, `BookingNo`, `TravelerCount`, `CustomerId`, `PackageId`) VALUES
(1, '2019-08-13', '326966', 2, 300548, 1),
(2, '2019-08-13', '326966', 2, 300548, 1),
(3, '2019-08-13', '562289', 2, 89841, 1),
(4, '2019-08-13', '562289', 2, 89841, 1),
(5, '2019-08-13', '971057', 2, 935049, 1),
(6, '2019-08-13', '971057', 2, 935049, 1),
(7, '2019-08-13', '45812', 2, 251477, 1),
(8, '2019-08-13', '45812', 2, 251477, 1),
(9, '2019-08-13', '689169', 2, 341411, 1),
(10, '2019-08-13', '689169', 2, 341411, 1);

-- --------------------------------------------------------

--
-- Table structure for table `cuscountry`
--

CREATE TABLE `cuscountry` (
  `id` int(11) NOT NULL,
  `iso` char(2) NOT NULL,
...
--
-- Dumping data for table `cuscountry`
--

INSERT INTO `cuscountry` (`id`, `iso`, `name`, `nicename`, `iso3`, `numcode`, `phonecode`) VALUES
...
(2, 'Polynesian Paradise', '2016-12-12 00:00:00', '2016-05-28 00:00:00', '8 Day All Inclusive Hawaiian Vacation', '3000.0000', '310.0000', 'images/island.png'),
(3, 'Asian Expedition', '2019-12-28 00:00:00', '2019-11-28 00:00:00', 'Airfaire, Hotel and Eco Tour.', '2800.0000', '300.0000', 'images/Asia.png'),
...
CREATE TABLE `cusregister` (
  ...
  `CusPassword` varchar(10) NOT NULL,
...
INSERT INTO `cusregister` (`CustomerId`, `CustFirstName`, `CustLastName`, `CusGender`, `CusAddress`, `CustCity`, `CustPostal`, `CustCountry`, `CustEmail`, `CusPassword`, `AgentId`) VALUES
(104, 'Laetia', 'Enison', 0, '', 'Edmonton', 'T2J 6B6', 'Canada', '                                                  ', '', 4),
(105, 'Angel', 'Moskowitz', 0, '', 'Calgary', 'T2J 7E3', 'Canada', 'amoskowitz@home.com                               ', '', 3),
(251477, 'dfg', '', 0, '', '', '', 'AF', 'shiju@gmail.com', '123', 2),
(341411, 'sfdg', 'sert', 0, 'sdfsd', 'Edmonton', '123', 'AF', 'shiju@gmail.com', '123', 2);
...
INSERT INTO `customers` (`CustomerId`, `CustFirstName`, `CustLastName`, `CustAddress`, `CustCity`, `CustPostal`, `CustCountry`, `CustEmail`, `Cusphone`, `AgentId`) VALUES
(104, 'Laetia', 'Enison', '144-61 87th Ave, NE', 'Edmonton', 'T2J 6B6', 'Canada', '                                                  ', '', 4),
(105, 'Angel', 'Moskowitz', '320 John St., NE', 'Calgary', 'T2J 7E3', 'Canada', 'amoskowitz@home.com                               ', '', 3),
(106, 'Judith', 'Olvsade', '29 Elmwood Ave.,', 'Calgary', 'T2Z 3M9', 'Canada', 'jolvsade@aol.com                                  ', '', 1),
(107, 'Catherine', 'Mierzwa', '22-70 41st St.,NW', 'Calgary', 'T2Z 2Z9', 'Canada', 'cmierzwa@msn.com                                  ', '', 4),
(108, 'Judy', 'Sethi', '63 Stratton Hall, SW', 'Calgary', 'T1Y 6N4', 'Canada', 'judysehti@home.com                                ', '', 7),
(109, 'Larry', 'Walter', '38 Bay 26th ST. #2A, NE', 'Calgary', 'T2J 6B6', 'Canada', 'lwalter@aol.com                                   ', '', 4),
(114, 'Winsome', 'Laporte', '268 E.3rd St, SW', 'Calgary', 'T1Y 6N4', 'Canada', '                                                  ', '', 8),
(117, 'Nancy', 'Kuehn', '44-255 9th St., SW', 'Calgary', 'T1Y 6N5', 'Canada', '                                                  ', '', 6),
(118, 'Hiedi', 'Lopez', '168 Rowayton Ave, NW', 'Calgary', 'T3A 4ZG', 'Canada', 'hlopez@aol.com                                    ', '', 4),
(119, 'Mardig', 'Abdou', '160-04 32nd Ave., SW', 'Calgary', 'T2P 2G7', 'Canada', '                                                  ', '', 9),
(120, 'Ralph', 'Alexander', '2054 73rd St, SW', 'Calgary', 'T2P 2G7', 'Canada', '                                                  ', '', 1),
(121, 'Sean', 'Pineda', '3 Salem Rd., NW', 'Calgary', 'T2K 3E3', 'Canada', 'spineda@hotmail.com                               ', '', 3),
(122, 'Julita', 'Lippen', '51-76 VanKleeck St., NW', 'Calgary', 'T2K 6C5', 'Canada', 'jlippen@cadvision.co                              ', '', 4),
(123, 'Pierre', 'Radicola', '322 Atkins Ave., SE', 'Calgary', 'T3G 2C6', 'Canada', 'pradicola@home.com                                ', '', 8),
(127, 'Gary', 'Aung', '135-32 Louis Blvd, NE', 'Calgary', 'T2V 2K5', 'Canada', '                                                  ', '', 9),
(128, 'Jeff', 'Runyan', '109-15 Queens Blvd., NE', 'Calgary', 'T2V 2K6', 'Canada', 'jrunyan@aol.com                                   ', '', 4),
(130, 'Lula', 'Oates', '11A Emory St., NE', 'Calgary', 'T3E 3Z4', 'Canada', 'loates@aol.com                                    ', '', 9),
(133, 'James', 'Reed', '109-621 96th St, NE', 'Calgary', 'T3E 4A1', 'Canada', 'jreed@aol.com                                     ', '', 2),
(135, 'Michellexxxxxxxxxxxxxx', 'Masser', '379 Ovington Ave, NE', 'Calgary', 'T2J 2S9', 'Canada', 'mmasser@aol.com                                   ', '', 6),
(138, 'John', 'Smith', '45 Plaza St. West #2D, NE', 'Calgary', 'T3E 5C7', 'Canada', 'johnSmith@hotmail.co                              ', '', 7),
(139, 'Angelo', 'Garshman', '82 Western Ave., NE', 'Calgary', 'T3E 5C8', 'Canada', '                                                  ', '', 3),
(140, 'Derrick', 'Baltazar', '9111 Church Ave. #3N, NE', 'Calgary', 'T3E 5C9', 'Canada', '                                                  ', '', 6),
(141, 'Robert', 'Boyd', '96-04 57th Ave #12A, NE', 'Calgary', 'T3E 5C5', 'Canada', '                                                  ', '', 3),
(142, 'Monica', 'Waldman', '257 Depot Rd., NE', 'Calgary', 'T2J 6P3', 'Canada', 'mwaldman@aol.com                                  ', '', 2),
(143, 'Gerard', 'Biers', '205 19th St., NE', 'Calgary', 'T2J 6B6', 'Canada', '                                                  ', '', 8),
(144, 'z', 'z', 'z', 'z', 'Z1Z1Z1', 'z', 'z@z.zz', '', 1),
(145, 'gf', 'dfg', ' Fill thidfs...', 'fgh', 'dfgfgh', 'dfg', 'dfgdf', 'f', 9),
(146, 'dfgdfg', 'ddfg', ' Fill dfthis...', 'dfg', 'dfg', 'dfg', 'FGHFGH@GMAIL.COM', 'dfghdfg', 9),
(147, 'fgh', 'fgh', ' Fill thfghis...', 'fghfgh', 'dfgfgh', 'fgh', 'FGHFGH@GMAIL.COM', 'fgh', 9),
(148, 'fdgh', 'fdg', ' Filf this...', 'fgh', '423rf', 'fgh', 'FGHFGH@GMAIL.COM', 'fgh', 9),
(149, 'fdgh', 'fdg', ' Filf this...', 'fgh', '423rf', 'fgh', 'FGHFGH@GMAIL.COM', 'fgh', 9),
(150, 'dsfg', 'SDF', ' Fillsdf this...', '', '', '', '', '', 9),
(151, 'dsfg', 'SDF', ' Fillsdf this...', '', '', '', '', '', 9),
(152, 'ASDFasd', 'SDF', ' Fill this.sdf..', 'fd', 'dfg', 'dfg', 'dfg', 'sdfgdfg', 9),
(153, 'dsfgsdfg', 'dfg', ' Fill tsdfgghis...', 'ddfg', 'sdfg', 'g', 'sdfg', 'fg', NULL);
...
CREATE TABLE `tbl_cus` (
  ...
  `CustFirstName` varchar(25) CHARACTER SET utf8 NOT NULL,
  `CustLastName` varchar(25) CHARACTER SET utf8 NOT NULL,
  `CustAddress` varchar(75) CHARACTER SET utf8 NOT NULL,
  `CustCity` varchar(50) CHARACTER SET utf8 NOT NULL,
  `CustPostal` varchar(7) CHARACTER SET utf8 NOT NULL,
  `CustCountry` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  `CustEmail` varchar(50) CHARACTER SET utf8 NOT NULL,
  `Cusphone` varchar(10) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_cus` (`CustomerId`, `CustFirstName`, `CustLastName`, `CustAddress`, `CustCity`, `CustPostal`, `CustCountry`, `CustEmail`, `Cusphone`) VALUES
(104, 'Laetia', 'Enison', '144-61 87th Ave, NE', 'Edmonton', 'T2J 6B6', 'Canada', '                                                  ', ''),
(105, 'Angel', 'Moskowitz', '320 John St., NE', 'Calgary', 'T2J 7E3', 'Canada', 'amoskowitz@home.com                               ', ''),
(106, 'Judith', 'Olvsade', '29 Elmwood Ave.,', 'Calgary', 'T2Z 3M9', 'Canada', 'jolvsade@aol.com                                  ', ''),
(107, 'Catherine', 'Mierzwa', '22-70 41st St.,NW', 'Calgary', 'T2Z 2Z9', 'Canada', 'cmierzwa@msn.com                                  ', ''),
(108, 'Judy', 'Sethi', '63 Stratton Hall, SW', 'Calgary', 'T1Y 6N4', 'Canada', 'judysehti@home.com                                ', ''),
(109, 'Larry', 'Walter', '38 Bay 26th ST. #2A, NE', 'Calgary', 'T2J 6B6', 'Canada', 'lwalter@aol.com                                   ', ''),
(114, 'Winsome', 'Laporte', '268 E.3rd St, SW', 'Calgary', 'T1Y 6N4', 'Canada', '                                                  ', ''),
(117, 'Nancy', 'Kuehn', '44-255 9th St., SW', 'Calgary', 'T1Y 6N5', 'Canada', '                                                  ', ''),
(118, 'Hiedi', 'Lopez', '168 Rowayton Ave, NW', 'Calgary', 'T3A 4ZG', 'Canada', 'hlopez@aol.com                                    ', ''),
(119, 'Mardig', 'Abdou', '160-04 32nd Ave., SW', 'Calgary', 'T2P 2G7', 'Canada', '                                                  ', ''),
(120, 'Ralph', 'Alexander', '2054 73rd St, SW', 'Calgary', 'T2P 2G7', 'Canada', '                                                  ', ''),
(121, 'Sean', 'Pineda', '3 Salem Rd., NW', 'Calgary', 'T2K 3E3', 'Canada', 'spineda@hotmail.com                               ', ''),
(122, 'Julita', 'Lippen', '51-76 VanKleeck St., NW', 'Calgary', 'T2K 6C5', 'Canada', 'jlippen@cadvision.co                              ', ''),
(123, 'Pierre', 'Radicola', '322 Atkins Ave., SE', 'Calgary', 'T3G 2C6', 'Canada', 'pradicola@home.com                                ', ''),
(127, 'Gary', 'Aung', '135-32 Louis Blvd, NE', 'Calgary', 'T2V 2K5', 'Canada', '                                                  ', ''),
(128, 'Jeff', 'Runyan', '109-15 Queens Blvd., NE', 'Calgary', 'T2V 2K6', 'Canada', 'jrunyan@aol.com                                   ', ''),
(130, 'Lula', 'Oates', '11A Emory St., NE', 'Calgary', 'T3E 3Z4', 'Canada', 'loates@aol.com                                    ', ''),
(133, 'James', 'Reed', '109-621 96th St, NE', 'Calgary', 'T3E 4A1', 'Canada', 'jreed@aol.com                                     ', ''),
(135, 'Michellexxxxxxxxxxxxxx', 'Masser', '379 Ovington Ave, NE', 'Calgary', 'T2J 2S9', 'Canada', 'mmasser@aol.com                                   ', ''),
(138, 'John', 'Smith', '45 Plaza St. West #2D, NE', 'Calgary', 'T3E 5C7', 'Canada', 'johnSmith@hotmail.co                              ', ''),
(139, 'Angelo', 'Garshman', '82 Western Ave., NE', 'Calgary', 'T3E 5C8', 'Canada', '                                                  ', ''),
(140, 'Derrick', 'Baltazar', '9111 Church Ave. #3N, NE', 'Calgary', 'T3E 5C9', 'Canada', '                                                  ', ''),
(141, 'Robert', 'Boyd', '96-04 57th Ave #12A, NE', 'Calgary', 'T3E 5C5', 'Canada', '                                                  ', ''),
(142, 'Monica', 'Waldman', '257 Depot Rd., NE', 'Calgary', 'T2J 6P3', 'Canada', 'mwaldman@aol.com                                  ', ''),
(143, 'Gerard', 'Biers', '205 19th St., NE', 'Calgary', 'T2J 6B6', 'Canada', '                                                  ', ''),
(144, 'z', 'z', 'z', 'z', 'Z1Z1Z1', 'z', 'z@z.zz', ''),
(145, 'gf', 'dfg', ' Fill thidfs...', 'fgh', 'dfgfgh', 'dfg', 'dfgdf', 'f'),
(146, 'dfgdfg', 'ddfg', ' Fill dfthis...', 'dfg', 'dfg', 'dfg', 'FGHFGH@GMAIL.COM', 'dfghdfg'),
(147, 'fgh', 'fgh', ' Fill thfghis...', 'fghfgh', 'dfgfgh', 'fgh', 'FGHFGH@GMAIL.COM', 'fgh'),
(148, 'fdgh', 'fdg', ' Filf this...', 'fgh', '423rf', 'fgh', 'FGHFGH@GMAIL.COM', 'fgh'),
(149, 'fdgh', 'fdg', ' Filf this...', 'fgh', '423rf', 'fgh', 'FGHFGH@GMAIL.COM', 'fgh'),
(150, 'dsfg', 'SDF', ' Fillsdf this...', '', '', '', '', ''),
(151, 'dsfg', 'SDF', ' Fillsdf this...', '', '', '', '', ''),
(152, 'ASDFasd', 'SDF', ' Fill this.sdf..', 'fd', 'dfg', 'dfg', 'dfg', 'sdfgdfg'),
(0, 'ASDFasd', 'SDF', ' Fill this.sdf..', 'fd', 'dfg', 'dfg', 'dfg', 'sdfgdfg'),
(0, 'sadf', 'sdfa', ' Fill this...', 'asdfasdf', 'dsf', 'sadf', 'sdfg', 'asdf'),
(0, 'sadf', 'sdfa', ' Fill this...', 'asdfasdf', 'dsf', 'sadf', 'sdfg', 'asdf'),
(0, 'asdfasdf', 'asdf', ' Fill asfdthis...', 'sdfgsdfgdfg', 'asf', 'asdf', 'asdf', 'sadf');
...
INSERT INTO `userlogin` (`usrid`, `usrname`, `usrpass`) VALUES
(31, 'sadf', 'sdf'),
(32, 'sadf', 'sdf'),
(33, 'dfg', '123'),
(34, 'dfg', '123'),
...
--
-- Indexes for table `cusbooking`
--
ALTER TABLE `cusbooking`
  ADD PRIMARY KEY (`BookingId`);

--
-- Indexes for table `cuscountry`
--
ALTER TABLE `cuscountry`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cusbooking`
--
ALTER TABLE `cusbooking`
  MODIFY `BookingId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `cuscountry`
--
ALTER TABLE `cuscountry`
...
--
ALTER TABLE `userlogin`
  MODIFY `usrid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
