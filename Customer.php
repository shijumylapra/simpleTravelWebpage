...
<body id="page1">
    ...
    $nameError = "";
    $Query1 = ("INSERT INTO cusregister(CustomerId,CustFirstName,CustLastName,CusGender,CusAddress,CustCity,CustPostal,CustCountry,CustEmail,CusPassword,AgentId) VALUES ($rand,'$_POST[txtfname]','$_POST[txtlname]','$_POST[txtaddress]','$_POST[txtaddress]','$_POST[txtcity]','$_POST[txtpostal]','$_POST[txtcountry]','$_POST[txtemail]','$_POST[txtpass1]','2')");
    ...
    $Query2 = ("INSERT INTO cusbooking(BookingDate,BookingNo,TravelerCount,CustomerId,PackageId) VALUES('$date','$BkN',2,$rand,$PckID)");
    if (mysqli_query($bcon, $Query2)) 
    {
        
        $nameError = "<b>Your contact information is saved successfully.</b>";
    } 
    else 
    {
    echo "Error: " . $Query2 . "" . mysqli_error($bcon);
    }
...
<div class="extra" >
    <div class="main">
        ...
        <div id="main-wrap">
            ...
            <div class="form-style-2">
                ...
                <form id="form_id" name="myForm" method="POST" onsubmit= "return sendEnquiryform()"> 
                    ...
                    <label for="field5"><span>Address <span class="required">*</span></span><textarea cols="5" rows="15" maxlength="250" name="txtaddress" class="textarea-field"></textarea></label>
                    <label for="field1"><span>E-mail <span class="required">*</span></span><input type="email" class="input-field" name="txtemail" value="" /></label>
		...
		<tr>
			...
			<th id="Packages Description" colspan="3">Packages Description   Start Date - End Date</th>
		</tr>
    <?php   
         include('mysql_connect.php');
         $PckID = $_GET['var'];
    $Query3 = "SELECT * FROM cuspackages1 where PackageId = $PckID";
...
//       $date_today  = new DateTime('2000-01-01', new DateTimeZone('Canada/saskatchewan'));
 //      $date_today = date("Y-m-d H:i:s",strtotime($date_today));
    ...
    $Query2 = ("INSERT INTO bookings1(BookingDate,BookingNo,TravelerCount,CustomerId,TripTypeId,PackageId) VALUES(' $date','$BookingNo',$TravelerCount,$rand,$TripTypeId,$PackageId)");
   
            if (mysqli_query($bcon, $Query2)) 
        {
           
      
  $nameError = "Your contact information is saved ss.";
